...
void BulletCollisionChecker::AddRobot(scp::Vec3 a, scp::Vec3 r, scp::Quat q) {
  ...
  */
  ...
  // std::cout << "Creating ellipsoidal robot with semi-major axes (xyz): "
  // << a[0] << " " << a[1] << " " << a[2] <<
  // std::endl; btSphereShape* sphere_shape = new btSphereShape(a[0]);  // defaults to value in header
...
void BulletCollisionChecker::AddObstacle(scp::Vec3 a, scp::Vec3 r, scp::Quat q) {
  ...
  */
  ...
  // std::cout << "Creating ellipsoidal obstacle with semi-major axes (xyz): "
  // << a[0] << " " << a[1] << " " << a[2] <<
  // std::endl; btSphereShape* sphere_shape = new btSphereShape(a[0]);  // 0.2
